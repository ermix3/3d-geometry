...
Smal.ConfigManager = function() { this.items = [] },
    Smal.ConfigManager.prototype = {
      read : function(t, i) {
        ...
        s.open("GET", t, !0),
            s.responseType = "text", s.send(), s.onload = function() {
              200 == s.status
    ...
    Smal.TextureManager =
      ...
      this.gl = t,
      t ||
          log("[ERROR] Smal.TextureManager.contructor requires GL context as a param."),
      this.textures = {}, this.count = 0,
    ...
    Smal.TextureManager.prototype = {
      load : function(t, i, e, s) {
        let r = null, n = t.substring(t.lastIndexOf("/") + 1);
        if (!n)
          return r = e == Smal.TextureType.NORMALMAP
                         ? this.textures.defaultNormalmap
                     : e == Smal.TextureType.OCCLUSIONMAP
                         ? this.textures.defaultOcclusionmap
                         : this.textures.defaultImage,
                 s && s(r), r;
        if (n in this.textures)
          return r = this.textures[n], s && s(r), r;
        let o = this.defaultImage;
        e == Smal.TextureType.NORMALMAP
            ? o = this.defaultNormalmap
            : e == Smal.TextureType.OCCLUSIONMAP &&
                  (o = this.defaultOcclusionmap),
              r = this.gl.createTexture(), this.setupTexture(r, o, i, e),
              this.textures[n] = r, this.count++,
              (o = new Image).crossOrigin = "anonymous";
        let h = this;
        return o.onload = function() { h.setupTexture(r, o, i, e), s && s(r) },
               o.onerror = function() {
      ...
      setupTexture : function(t, i, e, s) {
        ...
        s == Smal.TextureType.OCCLUSIONMAP && (n = r.LUMINANCE),
            ...
            r.texParameteri(r.TEXTURE_2D, r.TEXTURE_MIN_FILTER,
                            r.LINEAR_MIPMAP_LINEAR),
            e ? (r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_S, r.REPEAT),
                 r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_T, r.REPEAT))
              : (r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_S,
                                 r.CLAMP_TO_EDGE),
                 r.texParameteri(r.TEXTURE_2D, r.TEXTURE_WRAP_T,
                                 r.CLAMP_TO_EDGE)),
            r.generateMipmap(r.TEXTURE_2D), r.bindTexture(r.TEXTURE_2D, null)
      },
      createDefaultImage : function() {
        this.textures.defaultImage = this.gl.createTexture(), this.count++;
        let t = this, i = new Image;
        return i.src =
      ...
      createDefaultOcclusionmap : function() {
        ...
        return i.src =
               ...
               i.onload = function() {
                 t.setupTexture(t.textures.defaultOcclusionmap, i, !0,
                                Smal.TextureType.OCCLUSIONMAP)
               }, i
      },
      get : function(t) { return this.textures[t] },
    ...
    Smal.ShaderManager =
      ...
      this.gl = t,
      t ||
          log("[ERROR] Smal.ShaderManager.contructor requires GL context as a param."),
      this.programs = {}, this.count = 0
    },
    Smal.ShaderManager.prototype = {
      load : function(t, i, e) {
        e || (e = t.substring(t.lastIndexOf("/") + 1, t.lastIndexOf("."))),
            this.programs[e] = null, this.count++;
        let s = [ t, i ], r = this;
        return Promise.all(s.map(this.loadShaderSource))
            .then(t => {
              let i = r.createProgram(t[0], t[1]);
              return i ? (void 0 === r.programs[e] && r.count++,
                          r.programs[e] = i)
                       : r.removeProgram(e),
                     i
            })
          ...
          s.open("GET", t), s.send(),
              s.onload = (() => {
                if (200 == s.status)
                  ...
                  let i = "[ERROR] Failed to load glsl file(" + s.status +
      ...
      createProgram : function(t, i) {
        let e = this.gl, s = e.createShader(e.VERTEX_SHADER),
            r = e.createShader(e.FRAGMENT_SHADER);
        if (e.shaderSource(s, t), e.compileShader(s),
            !e.getShaderParameter(s, e.COMPILE_STATUS))
          return log("[ERROR] " + e.getShaderInfoLog(s)), null;
        if (e.shaderSource(r, i), e.compileShader(r),
            !e.getShaderParameter(r, e.COMPILE_STATUS))
          return log("[ERROR] " + e.getShaderInfoLog(r)), null;
        let n, o = e.createProgram();
        if (e.attachShader(o, s), e.attachShader(o, r), e.deleteShader(s),
            e.deleteShader(r), o.uniform = [], o.attribute = [],
            e.linkProgram(o), !e.getProgramParameter(o, e.LINK_STATUS))
          return log("[ERROR] Failed to initialize GLSL: " +
                     e.getProgramInfoLog(o)),
                 null;
        let h = e.getProgramParameter(o, e.ACTIVE_UNIFORMS);
        for (n = 0; n < h; ++n) {
          let t, i, s = e.getActiveUniform(o, n), r = s.name.indexOf(".");
          r >= 0 ? (t = s.name.substring(0, r), i = s.name.substring(r + 1),
                    void 0 === o.uniform[t] && (o.uniform[t] = {}),
                    o.uniform[t][i] = e.getUniformLocation(o, s.name))
                 : o.uniform[s.name] = e.getUniformLocation(o, s.name)
        }
        for (h = e.getProgramParameter(o, e.ACTIVE_ATTRIBUTES), n = 0; n < h;
             ++n) {
      ...
      getProgram : function(t) { return this.programs[t] },
      ...
      getProgramUniforms : function(t) {
        let i = [];
        for (key in this.programs[t].uniform)
          i.push(key);
        return i
      },
      getProgramAttributes : function(t) {
        let i = [];
        for (key in this.programs[t].attribute)
          i.push(key);
        return i
      },
      toString : function() {
    ...
    Smal.VertexBufferData =
        function(t) {
      this.gl = t,
      t ||
          log("[ERROR] Smal.VertexBufferData.contructor requires GL context as a param."),
      this.vboVertex = null, this.vboIndex = null, this.texId = null,
      this.indexCount = 0, this.polygonCount = 0, this.vertexSize = 0,
      this.normalSize = 0, this.texCoordSize = 0, this.tangentSize = 0,
      this.indexSize = 0, this.interleavedSize = 0, this.stride = 0,
      this.center = new Smal.Vector3(0, 0, 0), this.radius = 0, this.minX = 0,
      this.maxX = 0, this.minY = 0, this.maxY = 0, this.minZ = 0, this.maxZ = 0,
      this.drawMode = 1, this.ready = !1, this.textureUsed = !1,
      this.normalMapUsed = !1, this.occlusionMapUsed = !1,
    ...
    Smal.VertexBufferData.prototype = {
      read : function(t) {
        ...
        return new Promise((o, h) => {
          let a = this, l = new XMLHttpRequest;
          l.open("GET", t),
                       ...
                       200 == l.status
                           ? (
                                 !function(t, o) {
                                   ...
                                   t.ready = t.textureUsed = t.normalMapUsed =
                                       t.occlusionMapUsed = !1,
                                   t.indexSize = t.indexCount = t.polygonCount =
                                       t.vertexSize = t.normalSize =
                                           t.texCoordSize = t.tangentSize = 0,
                                   t.interleavedSize = t.stride = 0;
                                   let h = 0, a = new Uint8Array(o, h, 4),
                                       l = t.checkMagic(a), u = 4;
                                   l >= 0 && (h += 4, l % 5 == 2 && (u = 5));
                                   ...
                                   if (l <= 4) {
                                     ...
                                     h += t.indexSize,
                                         r = new Float32Array(
                                             o, h, m[1] * t.stride / 4);
                                   t.minX = c[0], t.maxX = c[1], t.minY = c[2],
                                   t.maxY = c[3], t.minZ = c[4], t.maxZ = c[5],
                                   ...
                                   (function(t) {
                                     let i = t.gl;
                                     t.vboVertex ||
                                         (t.vboVertex = i.createBuffer());
                                     i.bindBuffer(i.ARRAY_BUFFER, t.vboVertex),
                                         i.bufferData(i.ARRAY_BUFFER, r,
                                                      i.STATIC_DRAW),
                                         t.vboIndex ||
                                             (t.vboIndex = i.createBuffer());
                                     i.bindBuffer(i.ELEMENT_ARRAY_BUFFER,
                                                  t.vboIndex),
                                         i.bufferData(i.ELEMENT_ARRAY_BUFFER, n,
                                                      i.STATIC_DRAW)
                                   })(t),
                                       vertices = i = e = s = r = n = null,
                                       t.ready = !0
              ...
              l.onerror = (() => h("[ERROR] Failed to load a file: " + t +
                                   " (" + l.status + ")"))
        })
      },
      draw : function() {
        let t = this.gl;
        if (!this.vboVertex || !this.vboIndex)
          return !1;
        t.bindBuffer(t.ARRAY_BUFFER, this.vboVertex),
            t.vertexAttribPointer(t.program.attribute.vertexPosition, 3,
                                  t.FLOAT, !1, this.stride, 0),
            t.vertexAttribPointer(t.program.attribute.vertexNormal, 3, t.FLOAT,
                                  !1, this.stride, 12),
            this.normalMapUsed && this.texCoordSize > 0 &&
                this.tangentSize > 0 &&
                (t.vertexAttribPointer(t.program.attribute.vertexTexCoord0, 2,
                                       t.FLOAT, !1, this.stride, 24),
                 t.vertexAttribPointer(t.program.attribute.vertexTangent, 3,
                                       t.FLOAT, !1, this.stride, 32)),
            (this.textureUsed || this.occlusionMapUsed) &&
                this.texCoordSize > 0 &&
                t.vertexAttribPointer(t.program.attribute.vertexTexCoord0, 2,
                                      t.FLOAT, !1, this.stride, 24),
            t.bindBuffer(t.ELEMENT_ARRAY_BUFFER, this.vboIndex),
            2 == this.drawMode ? t.drawElements(t.LINE_STRIP, this.indexCount,
                                                this.indexType, 0)
            : 3 == this.drawMode
                ? t.drawElements(t.POINTS, this.indexCount, this.indexType, 0)
                : t.drawElements(t.TRIANGLES, this.indexCount, this.indexType,
                                 0)
      },
      checkMagic : function(
          t) { return 86 == t[0] && 66 == t[1] && 68 == t[2] ? t[3] - 48 : -1 },
      toString : function() {
        return "===== VBD Model =====\n Polygon Count: " + this.polygonCount +
    ...
    Smal.Sprite = function(t) {
      this.gl = t,
      t ? this.vboVertex = t.createBuffer()
        : (this.vboVertex = null,
           log("[WARNING] Smal.Sprite.contructor requires GL context as a param.")),
      this.width = 0, this.height = 0, this.texId = null,
      this.texCoords = new Smal.Vector4(0, 0, 1, 1),
      this.color = new Smal.Vector4(1, 1, 1, 1), this.matrix = new Smal.Matrix4,
      this.matrix.identity()
      ...
      getPosition : function() {
        return new Smal.Vector3(this.matrix.m[12], this.matrix.m[13],
                                this.matrix.m[14])
      },
      setSize : function(t, i) {
        ...
        return s[0] = .5 * -this.width, s[1] = .5 * this.height, s[2] = 0,
               s[3] = this.texCoords.x, s[4] = this.texCoords.y,
               s[5] = .5 * -this.width, s[6] = .5 * -this.height, s[7] = 0,
               s[8] = this.texCoords.x, s[9] = this.texCoords.w,
               s[10] = .5 * this.width, s[11] = .5 * this.height, s[12] = 0,
               s[13] = this.texCoords.z, s[14] = this.texCoords.y,
               s[15] = .5 * this.width, s[16] = .5 * -this.height, s[17] = 0,
               s[18] = this.texCoords.z, s[19] = this.texCoords.w,
               e.bindBuffer(e.ARRAY_BUFFER, this.vboVertex),
               e.bufferData(e.ARRAY_BUFFER, s, e.STATIC_DRAW),
               e.bindBuffer(e.ARRAY_BUFFER, null), this
      },
      setColor : function(t, i, e,
                          s) { return this.color.set(t, i, e, s), this },
      setTexture : function(t) { return this.texId = t, this },
      setTexCoords : function(
          t, i, e, s) { return this.texCoords.set(t, i, e, s), this },
      bindTexture : function() {
        return this.gl.activeTexture(this.gl.TEXTURE0),
               this.gl.bindTexture(this.gl.TEXTURE_2D, this.texId), this
      },
      ...
      draw : function() {
        if (!this.vboVertex)
          return !1;
        let t = this.gl;
        return t.uniformMatrix4fv(t.program.uniform.matrixModel, !1,
                                  this.matrix.m),
               t.bindBuffer(t.ARRAY_BUFFER, this.vboVertex),
               t.vertexAttribPointer(t.program.attribute.vertexPosition, 3,
                                     t.FLOAT, !1, 20, 0),
               t.vertexAttribPointer(t.program.attribute.vertexTexCoord0, 2,
                                     t.FLOAT, !1, 20, 12),
               t.drawArrays(t.TRIANGLE_STRIP, 0, 4), this
      },
      toString : function() {
        return "===== Sprite =====\n Position: (" + this.matrix.m[12] + ", " +
               this.matrix.m[13] + ", " + this.matrix.m[14] +
               ")\n    Width: " + this.width + "\n   Height: " + this.height +
...
Smal.BitmapCharacter = function() {
  this.x = 0, this.y = 0, this.width = 0, this.height = 0, this.xOffset = 0,
  this.yOffset = 0, this.xAdvance = 0, this.page = 0, this.s1 = 0, this.s2 = 1,
  this.t1 = 0, this.t2 = 1
}, Smal.BitmapFont = function(t) {
  this.gl = t,
  t ||
      log("[ERROR] Smal.BitmapFont.contructor requires GL context as a param."),
  this.height = 0, this.base = 0, this.bitmap = null, this.bitmapWidth = 0,
  this.bitmapHeight = 0, this.bitmapWidthInv = 1, this.bitmapHeightInv = 1,
  this.characterCount = 0, this.pages = [], this.characters = {},
  this.kernings = {}, this.path = "", this.vbo = null, this.vbo2 = null,
  this.scale = [ 1, 1 ], this.matrix = new Smal.Matrix4, this.matrix.identity()
}, Smal.BitmapFont.prototype = {
  loadFont : function(t) {
    this.path = t.substring(0, t.lastIndexOf("/") + 1),
    this.bitmap = t.substring(t.lastIndexOf("/") + 1);
    let i = this;
    Smal.loadFile(t).then(t => {i.parse(t), i.setUvs()})
  },
  parse : function(t) {
    for (let t = 0; t < this.pages.length; ++t)
      this.gl.deleteTexture(this.pages[t]);
    this.pages.length = 0, this.kernings = {}, this.characters = {},
    this.vbo || (this.vbo = this.gl.createBuffer());
    let i = t.split("\n");
    for (let t = 0, e = i.length; t < e; ++t) {
      let e = i[t].split(" "), s = e.shift();
      "info" == s || ("common" == s  ? this.parseCommon(e)
                      : "page" == s  ? this.parsePage(e)
                      : "chars" == s ? this.parseCharacterCount(e)
                      : "char" == s  ? this.parseCharacter(e)
  ...
  trimQuotes : function(t) { return t.substring(1, t.length - 2) },
  parseCommon : function(t) {
    for (let i = 0, e = t.length; i < e; ++i) {
      let e = this.getKeyAndValue(t[i]);
      "lineHeight" == e.key ? this.height = parseInt(e.value)
      : "base" == e.key     ? this.base = parseInt(e.value)
      : "scaleW" == e.key
          ? (this.bitmapWidth = parseInt(e.value),
             this.bitmapWidthInv = 1 / this.bitmapWidth)
          : "scaleH" == e.key && (this.bitmapHeight = parseInt(e.value),
  ...
  parseCharacter : function(t) {
    ...
    for (let e = 0, s = t.length; e < s; ++e) {
      ...
      if ("id" == s.key) {
        ...
        "x" == s.key         ? this.characters[i].x = parseInt(s.value)
        : "y" == s.key       ? this.characters[i].y = parseInt(s.value)
        : "width" == s.key   ? this.characters[i].width = parseInt(s.value)
        : "height" == s.key  ? this.characters[i].height = parseInt(s.value)
        : "xoffset" == s.key ? this.characters[i].xOffset = parseInt(s.value)
        : "yoffset" == s.key ? this.characters[i].yOffset = parseInt(s.value)
        : "xadvance" == s.key
            ? this.characters[i].xAdvance = parseInt(s.value)
            : "page" == s.key && (this.characters[i].page = parseInt(s.value))
    }
  },
  ...
  drawText : function(t, i, e, s) {
    ...
    for (let i = 0, e = t.length; i < e; ++i) {
      ...
      h = (o = (this.base - e.yOffset) * this.scale[1]) -
          e.height * this.scale[1],
      BitmapQuad[0] = r, BitmapQuad[1] = o, BitmapQuad[2] = 0,
      BitmapQuad[3] = e.s1, BitmapQuad[4] = e.t1, BitmapQuad[5] = r,
      BitmapQuad[6] = h, BitmapQuad[7] = 0, BitmapQuad[8] = e.s1,
      BitmapQuad[9] = e.t2, BitmapQuad[10] = n, BitmapQuad[11] = o,
      BitmapQuad[12] = 0, BitmapQuad[13] = e.s2, BitmapQuad[14] = e.t1,
      BitmapQuad[15] = n, BitmapQuad[16] = h, BitmapQuad[17] = 0,
      BitmapQuad[18] = e.s2, BitmapQuad[19] = e.t2, a.activeTexture(a.TEXTURE0),
      ...
      a.vertexAttribPointer(a.program.attribute.vertexPosition, 3, a.FLOAT, !1,
                            20, 0),
      a.vertexAttribPointer(a.program.attribute.vertexTexCoord0, 2, a.FLOAT, !1,
                            20, 12),
      a.drawArrays(a.TRIANGLE_STRIP, 0, 4), c += this.characters[u].xAdvance,
      l = u
    }
    return this
  },
  getTextWidth : function(t) {
    ...
    for (let n = 0, o = t.length; n < o; ++n)
      s = i + "-" + (e = t.charCodeAt(n)), r += this.kernings[s] || 0,
      r += this.characters[e].xAdvance, i = e;
    return Math.round(r * this.scale[0])
  },
  setScale : function(t,
                      i) { return this.scale[0] = t, this.scale[1] = i, this },
  toString : function() {
    return "===== BitmapFont =====\n         Bitmap: " + this.bitmap +
           "\n    Bitmap Size: " + this.bitmapWidth + " x " +
...
Smal.LineSegment =
  ...
  this.vbo = t.createBuffer(), this.width = 1, this.widthRatio = 1
},
    Smal.LineSegment.prototype = {
      setWidth : function(
          t, i) { return this.width = t, this.widthRatio = i || 1, this },
      draw : function(t, i, e, s, r, n) {
        let o = this.gl;
        if (this.width <= 1)
          LineVertices[0] = t, LineVertices[1] = i, LineVertices[2] = e,
          LineVertices[3] = s, LineVertices[4] = r, LineVertices[5] = n,
          o.bindBuffer(o.ARRAY_BUFFER, this.vbo),
          o.bufferData(o.ARRAY_BUFFER, LineVertices, o.DYNAMIC_DRAW),
          o.vertexAttribPointer(o.program.attribute.vertexPosition, 3, o.FLOAT,
                                !1, 0, 0),
          ...
          let l = Smal.Vector3.cross(a, h),
              u = this.width * this.widthRatio * .5, m = l.clone().scale(u),
              c = h.clone().scale(u);
          LineVertices[0] = t + m.x, LineVertices[1] = i + m.y,
          LineVertices[2] = e + m.z, LineVertices[3] = t - c.x,
          LineVertices[4] = i - c.y, LineVertices[5] = e - c.z,
          LineVertices[6] = t - m.x, LineVertices[7] = i - m.y,
          LineVertices[8] = e - m.z, LineVertices[9] = s - m.x,
          LineVertices[10] = r - m.y, LineVertices[11] = n - m.z,
          LineVertices[12] = s + c.x, LineVertices[13] = r + c.y,
          LineVertices[14] = n + c.z, LineVertices[15] = s + m.x,
          LineVertices[16] = r + m.y, LineVertices[17] = n + m.z,
          o.bindBuffer(o.ARRAY_BUFFER, this.vbo),
          o.bufferData(o.ARRAY_BUFFER, LineVertices, o.DYNAMIC_DRAW),
          o.vertexAttribPointer(o.program.attribute.vertexPosition, 3, o.FLOAT,
                                !1, 0, 0),
    ...
    Smal.ObjGroup =
        function() {
      this.name = "", this.materialName = "", this.indexOffset = 0,
      this.indexCount = 0
    },
    Smal.ObjModel =
        function() {
      this.groupCount = 0, this.vertexCount = 0, this.normalCount = 0,
      this.texCoordCount = 0, this.indexCount = 0, this.triangleCount = 0,
      this.groups = [], this.vertices = null, this.normals = null,
      this.texCoords = null, this.indices = null,
      this.center = new Smal.Vector3, this.radius = 0, this.minX = 0,
      this.minY = 0, this.minZ = 0, this.maxX = 0, this.maxY = 0, this.maxZ = 0
    },
    Smal.ObjModel.prototype = {
      read : function(t) {
        return new Promise((e, s) => {
          ...
          if (t instanceof String || "string" == typeof t) {
            ...
            n.open("GET", t, !0), n.send(), n.onload = function(o) {
              200 == n.status ? (i(r, n.responseText), e(r))
            ...
            n.readAsText(t),
                n.onload = function(t) { i(r, t.target.result), e(r) },
                n.onerror = function(
                    i) { s("[ERROR] Failed to load OBJ file" + t.name) }
          }
        });
        function i(t, i) {
          t.vertices = t.normals = t.texCoords = t.indices = null,
          t.groups.length = 0;
          let s, r, n, o, h, a = [], l = [], u = [], m = [], c = [], d = [],
                             f = [], x = {}, g = -1, C = i.split(/\r\n|\r|\n/);
          for (n in C)
            if ("#" != (s = C[n]).charAt(0) &&
                !((r = s.split(" ")).length <= 0))
              if ("g" == r[0]) {
                ...
                let t, i, s, n;
                for (t = r.length > 4 ? e(r) : [ r[1], r[2], r[3] ], h = 0;
                     h < t.length; h++)
                  if (void 0 == x[t[h]]) {
                    let e = t[h].split("/");
                    i = 3 * (parseInt(e[0]) - 1),
          ...
          t.vertices = new Float32Array(a), t.normals = new Float32Array(l),
          t.texCoords = new Float32Array(u), t.indices = new Uint16Array(m),
          ...
          t.triangleCount = t.indexCount / 3 || 0, function(t) {
            t.minX = 1 / 0, t.minY = 1 / 0, t.minZ = 1 / 0, t.maxX = -1 / 0,
            t.maxY = -1 / 0, t.maxZ = -1 / 0;
            let i = new Smal.Vector3, e = t.vertices.length;
            for (let s = 0; s < e; s += 3)
            ...
            t.center.z = (t.maxZ + t.minZ) / 2, t.radius = 0;
            for (let s = 0; s < e; s += 3)
              i.set(t.vertices[s], t.vertices[s + 1], t.vertices[s + 2]),
      ...
      normalize : function() {
        ...
        for (let i = 0; i < t; i += 3) {
          let t = 1 / Math.sqrt(this.normals[i] * this.normals[i] +
                                this.normals[i + 1] * this.normals[i + 1] +
                                this.normals[i + 2] * this.normals[i + 2]);
          this.normals[i] *= t, this.normals[i + 1] *= t,
              this.normals[i + 2] *= t
        }
      },
      clearArrays : function() {
        this.vertices = null, this.normals = null, this.texCoords = null,
        this.indices = null, this.groups.length = 0, this.vertexCount = 0,
        this.normalCount = 0, this.texCoordCount = 0, this.indexCount = 0,
        this.groupCount = 0
      },
      toString : function() {
    ...
    Smal.ObjModel.toVertices =
        function(t) {
      let i = [];
      if (!(t && t instanceof Smal.ObjModel))
        return i;
      for (let e = 0; e < t.indexCount; ++e) {
        let s = 3 * t.indices[e],
            r = new Smal.Vector3(t.vertices[s], t.vertices[s + 1],
                                 t.vertices[s + 2]);
        i.push(r)
      }
      return i
    ...
    Smal.Edge =
        function() {
      this.vertex1 = new Smal.Vector3, this.vertex2 = new Smal.Vector3,
      this.normal1 = new Smal.Vector3, this.normal2 = new Smal.Vector3
    },
    Smal.Edge.prototype = {
      toString : function() {
    ...
    Smal.Edge.generateEdges = function(t) {
      ...
      for (let e = 0, s = t.length; e < s; e += 3) {
        let s = t[e].clone(), r = t[e + 1].clone(), n = t[e + 2].clone();
        r.subtract(s), n.subtract(s);
        let o = Smal.Vector3.cross(r, n).normalize();
        r = t[e + 1].clone(), n = t[e + 2].clone();
        let h = [];
        h[0] = new Smal.Edge, h[0].vertex1.set(s.x, s.y, s.z),
        h[0].vertex2.set(r.x, r.y, r.z), h[0].normal1.set(o.x, o.y, o.z),
        h[1] = new Smal.Edge, h[1].vertex1.set(r.x, r.y, r.z),
        h[1].vertex2.set(n.x, n.y, n.z), h[1].normal1.set(o.x, o.y, o.z),
        h[2] = new Smal.Edge, h[2].vertex1.set(n.x, n.y, n.z),
        h[2].vertex2.set(s.x, s.y, s.z), h[2].normal1.set(o.x, o.y, o.z);
        for (let t = 0; t < 3; ++t) {
      ...
      for (let e = 0, s = t.length; e < s; ++e) {
        let s = t[e];
        if (i.vertex1.x == s.vertex2.x && i.vertex1.y == s.vertex2.y &&
            i.vertex1.z == s.vertex2.z && i.vertex2.x == s.vertex1.x &&
            i.vertex2.y == s.vertex1.y && i.vertex2.z == s.vertex1.z)
          return e
      }
      return -1
    }, Smal.Edge.toFloat32Array = function(t) {
      let i = t.length, e = 0, s = new Float32Array(2 * i * 3);
      for (let r = 0; r < i; ++r)
        s[e = 6 * r] = t[r].vertex1.x, s[e + 1] = t[r].vertex1.y,
                  s[e + 2] = t[r].vertex1.z, s[e + 3] = t[r].vertex2.x,
                  s[e + 4] = t[r].vertex2.y, s[e + 5] = t[r].vertex2.z;
      return s
    };
const PEN_WIDTH = 10, PEN_COLOR = new Float32Array([ 0, 0, 0, 1 ]),
      PEN_TOOL_BLOCK_SIZE = 128;
Smal.PenTool =
    function(t) {
  this.gl = t,
  t || log("[ERROR] Smal.PenTool.contructor requires GL context as a param."),
  this.vbo = t.createBuffer(), this.points = null, this.pointCount = 0,
  this.pointCapacity = 128, this.stroke = {}, this.stroke.color = PEN_COLOR,
  this.stroke.width = 10, this.stroke.start = 0, this.stroke.end = 0,
  this.strokes = [], this.prevX = null, this.prevY = null, this.reset()
},
    Smal.PenTool.prototype = {
      setWidth : function(t) { this.stroke.width = t },
      setColor : function(t, i, e, s) {
        this.stroke.color[0] = t, this.stroke.color[1] = i,
        this.stroke.color[2] = e, this.stroke.color[3] = s
      },
      reset : function() {
        this.points = new Float32Array(256), this.pointCount = 0,
        this.pointCapacity = 128, this.strokes.length = 0, this.resizeVbo()
      },
      undo : function() {
        ...
        t ? (this.pointCount = t.end + 1, this.stroke.start = t.start)
          : (this.pointCount = 0, this.stroke.start = 0)
      },
      increaseBuffer : function(t) {
        for (; this.pointCapacity < t;)
      ...
      startAt : function(t, i) {
        ...
        this.points[e] = t, this.points[e + 1] = i,
        this.stroke.start = this.pointCount,
        this.strokes.length > 0 &&
            (this.strokes[this.strokes.length - 1].end = this.pointCount - 1),
        this.prevX = t, this.prevY = i, ++this.pointCount,
        this.strokes.push(this.stroke);
        let s = {};
        s.color = new Float32Array(this.stroke.color),
        s.width = this.stroke.width, this.stroke = s, this.updateVbo()
      },
      moveTo : function(t, i) {
        let e = t - this.prevX, s = i - this.prevY,
            r = Math.sqrt(e * e + s * s);
        if (r < 1)
          return;
        ...
        let o = 2 * this.pointCount, h = 0;
        for (let t = 1; t <= n; ++t)
          h = t / n, this.points[o] = this.prevX + e * h,
          this.points[o + 1] = this.prevY + s * h, this.pointCount++, o += 2;
        this.prevX = t, this.prevY = i, this.updateVbo()
      },
      draw : function() {
        let t, i = this.gl;
        i.bindBuffer(i.ARRAY_BUFFER, this.vbo),
            i.vertexAttribPointer(i.program.attribute.vertexPosition, 2,
                                  i.FLOAT, !1, 0, 0);
    ...
    Smal.Quad =
      ...
      this.left = i || -.5, this.right = e || .5, this.bottom = s || -.5,
      this.top = r || .5, this.reversed = !1, this.vbo = t.createBuffer(),
      this.initVbo()
    },
    Smal.Quad.prototype = {
      initVbo : function() {
        let t = new Float32Array(16);
        t[0] = this.left, t[1] = this.bottom, t[2] = 0, t[3] = 1,
        t[4] = this.right, t[5] = this.bottom, t[6] = 1, t[7] = 1,
        t[8] = this.right, t[9] = this.top, t[10] = 1, t[11] = 0,
        t[12] = this.left, t[13] = this.top, t[14] = 0, t[15] = 0,
      ...
      set : function(t, i, e, s) {
        return this.left = t, this.right = i, this.bottom = e, this.top = s,
               this.initVbo(), this
      },
      reverseTextureOrientation :
          function() { this.reversed = !this.reversed, this.initVbo() },
      draw : function() {
        let t = this.gl;
        return t.bindBuffer(t.ARRAY_BUFFER, this.vbo),
               t.vertexAttribPointer(t.program.attribute.vertexPosition, 2,
                                     t.FLOAT, !1, 16, 0),
               t.vertexAttribPointer(t.program.attribute.vertexTexCoord0, 2,
                                     t.FLOAT, !1, 16, 8),
               t.drawArrays(t.TRIANGLE_FAN, 0, 4), this
      }
    },
    Smal.Cylinder =
        function(t, i = 1, e = 1, s = 1, r = 36, n = 1, o = !0) {
      this.gl = t,
      t ||
          log("[WARNING] Smal.Cylinder.contructor requires GL context as a param."),
      this.baseRadius = i, this.topRadius = e, this.height = s,
      this.sectorCount = r, this.stackCount = n, this.smooth = o,
      this.unitCircleVertices = [], this.vertices = [], this.normals = [],
      this.texCoords = [], this.indices = [], this.interleavedVertices = [],
      this.stride = 32,
      t &&
          (this.vboVertex = t.createBuffer(), this.vboIndex = t.createBuffer()),
    ...
    Smal.Cylinder.prototype = {
      set : function(t, i, e, s, r, n) {
        return this.baseRadius = t, this.topRadius = i, this.height = e,
               this.sectorCount = s, this.stackCount = r, this.smooth = n,
               this.buildUnitCircleVertices(),
               this.smooth ? this.buildVerticesSmooth()
                           : this.buildVerticesFlat(),
               this
      },
      setBaseRadius : function(t) {
        return this.baseRadius != t &&
                   this.set(t, this.topRadius, this.height, this.sectorCount,
                            this.stackCount, this.smooth),
               this
      },
      setTopRadius : function(t) {
        return this.topRadius != t &&
                   this.set(this.baseRadius, t, this.height, this.sectorCount,
                            this.stackCount, this.smooth),
               this
      },
      setHeight : function(t) {
        return this.height != t &&
                   this.set(this.baseRadius, this.topRadius, t,
                            this.sectorCount, this.stackCount, this.smooth),
               this
      },
      setSectorCount : function(t) {
        return this.sectorCount != t &&
                   this.set(this.baseRadius, this.topRadius, this.height, t,
                            this.stackCount, this.smooth),
               this
      },
      setStackCount : function(t) {
        return this.stackCount != t &&
                   this.set(this.baseRadius, this.topRadius, this.height,
                            this.sectorCount, t, this.smooth),
               this
      },
      setSmooth : function(t) {
        return this.smooth != t &&
                   (this.smooth = t, this.smooth ? this.buildVerticesSmooth()
                                                 : this.buildVerticesFlat()),
               this
      },
      reverseNormals : function() {
        let t, i, e, s = this.normals.length;
        for (t = 0, i = 3; t < s; t += 3, i += 8)
          this.normals[t] *= -1, this.normals[t + 1] *= -1,
              this.normals[t + 2] *= -1,
        ...
        for (s = this.indices.length, t = 0; t < s; t += 3)
          e = this.indices[t], this.indices[t] = this.indices[t + 2],
          this.indices[t + 2] = e;
        this.buildVbos()
      },
      getTriangleCount : function() { return this.getIndexCount() / 3 },
      getIndexCount : function() { return this.indices.length },
      getVertexCount : function() { return this.vertices.length / 3 },
      getNormalCount : function() { return this.normals.length / 3 },
      getTexCoordCount : function() { return this.texCoords.length / 2 },
      toString : function() {
      ...
      clearArrays : function() {
        this.vertices.length = 0, this.normals.length = 0,
        this.texCoords.length = 0, this.indices.length = 0,
      ...
      buildUnitCircleVertices : function() {
        let t = 2 * Math.PI / this.sectorCount, i = 0;
        this.unitCircleVertices.length = 0,
        this.unitCircleVertices = new Float32Array(3 * (this.sectorCount + 1));
        for (let e = 0, s = 0; e <= this.sectorCount; ++e, s += 3)
          i = e * t, this.unitCircleVertices[s] = Math.cos(i),
      ...
      buildVerticesSmooth : function() {
        ...
        let m = 0, c = 0, d = 0, f = this.getSideNormals();
        for (o = 0; o <= this.stackCount; ++o)
          for (e = -.5 * this.height + o / this.stackCount * this.height,
              s = this.baseRadius +
                  o / this.stackCount * (this.topRadius - this.baseRadius),
              n = 1 - o / this.stackCount, h = 0, a = 0;
               h <= this.sectorCount; ++h, a += 3)
            t = this.unitCircleVertices[a], i = this.unitCircleVertices[a + 1],
            this.addVertex(m, t * s, i * s, e),
            this.addNormal(m, f[a], f[a + 1], f[a + 2]),
            r = h / this.sectorCount, this.addTexCoord(c, r, n), m += 3, c += 2;
        let x = m / 3;
        for (e = .5 * -this.height, this.addVertex(m, 0, 0, e),
            this.addNormal(m, 0, 0, -1), this.addTexCoord(c, .5, .5), m += 3,
            c += 2, o = 0, h = 0;
             o < this.sectorCount; ++o, h += 3)
          t = this.unitCircleVertices[h], i = this.unitCircleVertices[h + 1],
          this.addVertex(m, t * this.baseRadius, i * this.baseRadius, e),
          this.addNormal(m, 0, 0, -1),
          this.addTexCoord(c, .5 * -t + .5, .5 * -i + .5), m += 3, c += 2;
        let g = m / 3;
        for (e = .5 * this.height, this.addVertex(m, 0, 0, e),
            this.addNormal(m, 0, 0, 1), this.addTexCoord(c, .5, .5), m += 3,
            c += 2, o = 0, h = 0;
          ...
          this.addTexCoord(c, .5 * t + .5, .5 * -i + .5), m += 3, c += 2;
        for (o = 0; o < this.stackCount; ++o)
          for (u = (l = o * (this.sectorCount + 1)) + this.sectorCount + 1,
              h = 0;
               h < this.sectorCount; ++h, ++l, ++u)
            this.addIndices(d, l, l + 1, u),
                this.addIndices(d + 3, u, l + 1, u + 1), d += 6;
        for (o = 0, a = x + 1; o < this.sectorCount; ++o, ++a)
          o < this.sectorCount - 1 ? this.addIndices(d, x, a + 1, a)
                                   : this.addIndices(d, x, x + 1, a),
              d += 3;
        for (o = 0, a = g + 1; o < this.sectorCount; ++o, ++a)
          o < this.sectorCount - 1 ? this.addIndices(d, g, a, a + 1)
                                   : this.addIndices(d, g, a, g + 1),
              d += 3;
        this.buildInterleavedVertices(), this.buildVbos()
      },
      buildVerticesFlat : function() {
        let t, i, e, s, r, n, o, h, a, u, c, d, f, x, g, C, A, S = [], p = {};
        for (t = 0, m = 0; t <= this.stackCount; ++t)
          for (n = -.5 * this.height + t / this.stackCount * this.height,
              o = this.baseRadius +
                  t / this.stackCount * (this.topRadius - this.baseRadius),
              h = 1 - t / this.stackCount, i = 0, e = 0, l = 0;
               i <= this.sectorCount; ++i, e += 3, l += 2)
            p = {
            ...
            S.push(p);
        for (this.resizeArraysFlat(), g = C = A = x = 0, t = 0;
             t < this.stackCount; ++t)
          for (vi1 = t * (this.sectorCount + 1),
              vi2 = (t + 1) * (this.sectorCount + 1), i = 0;
               i < this.sectorCount; ++i, ++vi1, ++vi2) {
            for (a = S[vi1], u = S[vi2], c = S[vi1 + 1], d = S[vi2 + 1],
                ...
                f = Smal.Cylinder.computeFaceNormal(a.x, a.y, a.z, c.x, c.y,
                                                    c.z, u.x, u.y, u.z),
                e = 0;
                 e < 4; ++e)
              this.addNormal(g + 3 * e, f[0], f[1], f[2]);
            g += 12, C += 8, this.addIndices(A, x, x + 2, x + 1),
                this.addIndices(A + 3, x + 1, x + 2, x + 3), A += 6, x += 4
          }
        let R = g / 3;
        for (n = .5 * -this.height, this.addVertex(g, 0, 0, n),
            this.addNormal(g, 0, 0, -1), this.addTexCoord(C, .5, .5), g += 3,
            C += 2, t = 0, i = 0;
             t < this.sectorCount; ++t, i += 3)
          s = this.unitCircleVertices[i], r = this.unitCircleVertices[i + 1],
          this.addVertex(g, s * this.baseRadius, r * this.baseRadius, n),
          this.addNormal(g, 0, 0, -1),
          this.addTexCoord(C, .5 * -s + .5, .5 * -r + .5), g += 3, C += 2;
        for (t = 0, e = R + 1; t < this.sectorCount; ++t, ++e)
          t < this.sectorCount - 1 ? this.addIndices(A, R, e + 1, e)
        ...
        for (t = 0, e = T + 1; t < this.sectorCount; ++t, ++e)
          t < this.sectorCount - 1 ? this.addIndices(A, T, e, e + 1)
                                   : this.addIndices(A, T, e, T + 1),
              A += 3;
        this.buildInterleavedVertices(), this.buildVbos()
      },
      buildInterleavedVertices : function() {
        let t, i, e, s = this.getVertexCount();
        for (this.interleavedVertices.length = 0,
            this.interleavedVertices = new Float32Array(8 * s), t = 0, i = 0,
            e = 0;
             t < this.vertices.length; t += 3, i += 2, e += 8)
      ...
      buildVbos : function() {
        let t = this.gl;
        t.bindBuffer(t.ARRAY_BUFFER, this.vboVertex),
            t.bufferData(t.ARRAY_BUFFER, this.interleavedVertices,
                         t.STATIC_DRAW),
      ...
      getSideNormals : function() {
        let t = 2 * Math.PI / this.sectorCount, i = 0,
            ...
            s = Math.cos(e), r = Math.sin(e),
            n = new Float32Array(3 * (this.sectorCount + 1));
        for (let e = 0, o = 0; e <= this.sectorCount; ++e, o += 3)
          i = e * t, n[o] = Math.cos(i) * s, n[o + 1] = Math.sin(i) * s,
          n[o + 2] = r;
        return n
      },
      addVertex : function(t, i, e, s) {
        this.vertices[t] = i, this.vertices[t + 1] = e, this.vertices[t + 2] = s
      },
      addNormal : function(t, i, e, s) {
        this.normals[t] = i, this.normals[t + 1] = e, this.normals[t + 2] = s
      },
      addTexCoord : function(
          t, i, e) { this.texCoords[t] = i, this.texCoords[t + 1] = e },
      addIndices : function(t, i, e, s) {
        this.indices[t] = i, this.indices[t + 1] = e, this.indices[t + 2] = s
      }
    },
    Smal.Cylinder.computeFaceNormal =
        function(t, i, e, s, r, n, o, h, a) {
      let l = new Float32Array(3), u = s - t, m = r - i, c = n - e, d = o - t,
          f = h - i, x = a - e, g = m * x - c * f, C = c * d - u * x,
          A = u * f - m * d, S = Math.sqrt(g * g + C * C + A * A);
      return S > 1e-6 && (l[0] = g / S, l[1] = C / S, l[2] = A / S), l
    },
    Smal.Sphere =
        function(t, i = 1, e = 36, s = 18, r = !0) {
      this.gl = t,
      t ||
          log("[WARNING] Smal.Sphere.contructor requires GL context as a param."),
      this.radius = 1, this.sectorCount = 36, this.stackCount = 18,
      this.smooth = !0, this.vertices = [], this.normals = [],
      this.texCoords = [], this.indices = [], this.interleavedVertices = [],
      this.stride = 32,
      t &&
          (this.vboVertex = t.createBuffer(), this.vboIndex = t.createBuffer()),
    ...
    Smal.Sphere.prototype = {
      set : function(t, i, e, s) {
        return this.radius = t, this.sectorCount = i,
               i < 3 && (this.sectorCount = 3), this.stackCount = e,
               e < 2 && (this.stackCount = 2), this.smooth = s,
               s ? this.buildVerticesSmooth() : this.buildVerticesFlat(), this
      },
      ...
      resizeArraysSmooth : function() {
        ...
        this.indices =
            new Uint16Array(6 * this.sectorCount * (this.stackCount - 1))
      },
      resizeArraysFlat : function() {
        this.clearArrays();
        let t =
      ...
      buildVerticesSmooth : function() {
        ...
        this.resizeArraysSmooth();
        let g, C, A = 1 / this.radius, S = 2 * Math.PI / this.sectorCount,
                  p = Math.PI / this.stackCount;
        for (d = f = x = 0, l = 0; l <= this.stackCount; ++l)
          for (C = Math.PI / 2 - l * p, s = this.radius * Math.cos(C),
              e = this.radius * Math.sin(C), u = 0;
               u <= this.sectorCount; ++u)
            g = u * S, t = s * Math.cos(g), i = s * Math.sin(g),
            this.addVertex(d, t, i, e), r = t * A, n = i * A, o = e * A,
            this.addNormal(d, r, n, o), h = u / this.sectorCount,
            a = l / this.stackCount, this.addTexCoord(f, h, a), d += 3, f += 2;
        for (l = 0; l < this.stackCount; ++l)
          for (c = (m = l * (this.sectorCount + 1)) + this.sectorCount + 1,
              u = 0;
               u < this.sectorCount; ++u, ++m, ++c)
      ...
      buildVerticesFlat : function() {
        let t, i, e, s, r, n, o, h, a, l, u, m, c, d, f, x, g,
            C = 2 * Math.PI / this.sectorCount, A = Math.PI / this.stackCount,
            S = [], p = {};
        for (t = 0; t <= this.stackCount; ++t)
          for (g = Math.PI / 2 - t * A, r = this.radius * Math.cos(g),
              e = this.radius * Math.sin(g), i = 0;
               i <= this.sectorCount; ++i)
            x = i * C, p = {
              x : r * Math.cos(x),
              y : r * Math.sin(x),
              z : e,
            ...
            S.push(p);
        for (this.resizeArraysFlat(), c = d = f = m = 0, t = 0;
             t < this.stackCount; ++t)
          for (l = t * (this.sectorCount + 1),
              u = (t + 1) * (this.sectorCount + 1), i = 0;
               i < this.sectorCount; ++i, ++l, ++u)
            n = S[l], o = S[u], h = S[l + 1], a = S[u + 1],
            0 == t ? (this.addVertex(c, n.x, n.y, n.z),
            ...
            : t == this.stackCount - 1
                ? (this.addVertex(c, n.x, n.y, n.z),
                   ...
                   this.addNormal(c + 3, s[0], s[1], s[2]),
                   this.addNormal(c + 6, s[0], s[1], s[2]),
                   this.addIndices(f, m, m + 1, m + 2), c += 9, d += 6, f += 3,
                   m += 3)
                : (this.addVertex(c, n.x, n.y, n.z),
                   this.addVertex(c + 3, o.x, o.y, o.z),
                   this.addVertex(c + 6, h.x, h.y, h.z),
                   ...
                   this.addIndices(f + 3, m + 2, m + 1, m + 3), c += 12, d += 8,
                   f += 6, m += 4);
        this.buildInterleavedVertices(), this.buildVbos()
      },
      buildInterleavedVertices : function() {
    ...
    Smal.Cubesphere =
        function(t, i = 1, e = 3, s = !0) {
      this.gl = t,
      t ||
          log("[WARNING] Smal.Cubesphere.contructor requires GL context as a param."),
      this.radius = 1, this.subdivision = 3, this.smooth = !0,
      this.vertices = [], this.normals = [], this.texCoords = [],
      this.indices = [], this.interleavedVertices = [], this.stride = 32,
    ...
    Smal.Cubesphere.prototype = {
      set : function(t, i, e) {
        return this.radius = t, this.subdivision = i,
               i < 0 ? this.subdivision = 0 : i > 5 && (this.subdivision = 5),
               this.smooth = e,
               this.vertexCountPerRow = Math.pow(2, this.subdivision) + 1,
               e ? this.buildVerticesSmooth() : this.buildVerticesFlat(), this
      },
      setRadius : function(t) {
        return this.radius != t && this.set(t, this.subdivision, this.smooth),
               this
      },
      ...
      setSubdivision : function(t) {
        return this.subdivision != t && this.set(this.radius, t, this.smooth),
               this
      },
      setSmooth : function(t) {
        return this.smooth != t &&
      ...
      getSideLength : function() { return 2 * this.radius / Math.sqrt(3) },
      getTriangleCount : function() { return this.getIndexCount() / 3 },
      getIndexCount : function() { return this.indices.length },
      getVertexCount : function() { return this.vertices.length / 3 },
      getNormalCount : function() { return this.normals.length / 3 },
      ...
      buildVerticesSmooth : function() {
        let t, i, e, s, r, n, o, h, a, l, u, m, c,
            d = Smal.Cubesphere.getUnitPositiveX(this.vertexCountPerRow);
        for (this.resizeArraysSmooth(), u = m = c = h = 0, n = 0;
             n < this.vertexCountPerRow; ++n)
          for (l = (a = n * this.vertexCountPerRow) + this.vertexCountPerRow,
              r = n / (this.vertexCountPerRow - 1), o = 0;
               o < this.vertexCountPerRow; ++o, ++a, ++l)
            t = d[h], i = d[h + 1], e = d[h + 2],
            s = o / (this.vertexCountPerRow - 1),
            this.addVertex(u, t * this.radius, i * this.radius,
                           e * this.radius),
            this.addNormal(u, t, i, e), this.addTexCoord(m, s, r),
            n < this.vertexCountPerRow - 1 && o < this.vertexCountPerRow - 1 &&
                (this.addIndices(c, a, l, a + 1), c += 3,
                 this.addIndices(c, a + 1, l, l + 1), c += 3),
            u += 3, m += 2, h += 3;
        let f, x = 3 * this.vertexCountPerRow * this.vertexCountPerRow,
               g = 6 * Math.pow(4, this.subdivision);
        for (n = 0, o = 0; n < x; n += 3, o += 2)
          this.addVertex(u, -this.vertices[n], this.vertices[n + 1],
                         -this.vertices[n + 2]),
              this.addNormal(u, -this.normals[n], this.normals[n + 1],
                             -this.normals[n + 2]),
        ...
        for (n = 0, o = 0; n < x; n += 3, o += 2)
          this.addVertex(u, -this.vertices[n + 2], this.vertices[n],
                         -this.vertices[n + 1]),
              this.addNormal(u, -this.normals[n + 2], this.normals[n],
                             -this.normals[n + 1]),
              this.addTexCoord(m, this.texCoords[o], this.texCoords[o + 1]),
              u += 3, m += 2;
        ...
        for (f = 3 * x / 3, n = 0; n < g; ++n)
          this.indices[c] = f + this.indices[n], ++c;
        for (n = 0, o = 0; n < x; n += 3, o += 2)
          this.addVertex(u, -this.vertices[n + 2], this.vertices[n + 1],
                         this.vertices[n]),
              this.addNormal(u, -this.normals[n + 2], this.normals[n + 1],
                             this.normals[n]),
              this.addTexCoord(m, this.texCoords[o], this.texCoords[o + 1]),
              u += 3, m += 2;
      ...
      buildVerticesFlat : function() {
        ...
        for (h = a = l = e = 0, t = 0; t < this.vertexCountPerRow - 1; ++t)
          for (r = (s = t * this.vertexCountPerRow) + this.vertexCountPerRow,
              x[1] = C[1] = t / (this.vertexCountPerRow - 1),
              g[1] = A[1] = (t + 1) / (this.vertexCountPerRow - 1), i = 0;
               i < this.vertexCountPerRow - 1; ++i, ++s, ++r)
            n = 3 * s, o = 3 * r, m[0] = u[n], m[1] = u[n + 1], m[2] = u[n + 2],
            c[0] = u[o], c[1] = u[o + 1], c[2] = u[o + 2], d[0] = u[n + 3],
            d[1] = u[n + 4], d[2] = u[n + 5], f[0] = u[o + 3], f[1] = u[o + 4],
            f[2] = u[o + 5], S = Smal.Cubesphere.computeFaceNormal(m, c, d),
            ...
            this.addNormal(h, S[0], S[1], S[2]), h += 3,
            ...
            this.addNormal(h, S[0], S[1], S[2]), h += 3,
            this.addTexCoord(a, x[0], x[1]), a += 2,
            this.addTexCoord(a, g[0], g[1]), a += 2,
            this.addTexCoord(a, C[0], C[1]), a += 2,
            this.addTexCoord(a, A[0], A[1]), a += 2,
            this.addIndices(l, e, e + 1, e + 2), l += 3,
            this.addIndices(l, e + 2, e + 1, e + 3), l += 3, e += 4;
        let p, R = 12 * Math.pow(4, this.subdivision),
               T = 6 * Math.pow(4, this.subdivision);
        for (t = 0, i = 0; t < R; t += 3, i += 2)
          this.addVertex(h, -this.vertices[t], this.vertices[t + 1],
                         -this.vertices[t + 2]),
              this.addNormal(h, -this.normals[t], this.normals[t + 1],
                             -this.normals[t + 2]),
        ...
        for (t = 0, i = 0; t < R; t += 3, i += 2)
          this.addVertex(h, -this.vertices[t + 2], this.vertices[t],
                         -this.vertices[t + 1]),
              this.addNormal(h, -this.normals[t + 2], this.normals[t],
                             -this.normals[t + 1]),
              this.addTexCoord(a, this.texCoords[i], this.texCoords[i + 1]),
              h += 3, a += 2;
        ...
        for (p = 3 * R / 3, t = 0; t < T; ++t)
          this.indices[l] = p + this.indices[t], ++l;
        for (t = 0, i = 0; t < R; t += 3, i += 2)
          this.addVertex(h, -this.vertices[t + 2], this.vertices[t + 1],
                         this.vertices[t]),
              this.addNormal(h, -this.normals[t + 2], this.normals[t + 1],
                             this.normals[t]),
              this.addTexCoord(a, this.texCoords[i], this.texCoords[i + 1]),
              h += 3, a += 2;
    ...
    Smal.Cubesphere.computeScaleForLength = function(
        t, i, e, s) { return s / Math.sqrt(t * t + i * i + e * e) },
    Smal.Cubesphere.getUnitPositiveX =
        function(t) {
      const i = Math.acos(-1) / 180;
      let e, s, r, n, o, h, a = new Float32Array(3 * t * t),
                            l = new Float32Array(3), u = new Float32Array(3),
                            m = new Float32Array(3);
      for (h = 0, n = 0; n < t; ++n)
        for (s = i * (45 - 90 * n / (t - 1)), u[0] = -Math.sin(s),
            u[1] = Math.cos(s), u[2] = 0, o = 0;
             o < t; ++o)
          e = i * (90 * o / (t - 1) - 45), l[0] = -Math.sin(e), l[1] = 0,
          l[2] = -Math.cos(e), m[0] = l[1] * u[2] - l[2] * u[1],
          m[1] = l[2] * u[0] - l[0] * u[2], m[2] = l[0] * u[1] - l[1] * u[0],
          r = Smal.Cubesphere.computeScaleForLength(m[0], m[1], m[2], 1),
          Smal.Cubesphere.scaleVertex(m, r), a[h] = m[0], a[h + 1] = m[1],
          a[h + 2] = m[2], h += 3;
      return a
    },
    Smal.Cubesphere.computeFaceNormal =
        function(t, i, e) {
      let s = new Float32Array(3), r = i[0] - t[0], n = i[1] - t[1],
          o = i[2] - t[2], h = e[0] - t[0], a = e[1] - t[1], l = e[2] - t[2],
          u = n * l - o * a, m = o * h - r * l, c = r * a - n * h,
          d = Math.sqrt(u * u + m * m + c * c);
      return d > 1e-6 && (s[0] = u / d, s[1] = m / d, s[2] = c / d), s
    },
    Smal.Cubesphere.scaleVertex = function(
        t, i) { t[0] *= i, t[1] *= i, t[2] *= i },
    Smal.Cone =
        function(t, i = 1, e = 1, s = 36, r = 1, n = !0) {
      this.gl = t,
      t ||
          log("[WARNING] Smal.Cone.contructor requires GL context as a param."),
      this.baseRadius = i, this.height = e, this.sectorCount = s,
      this.stackCount = r, this.smooth = n, this.apexNormalMode = 0,
      this.unitCircleVertices = [], this.vertices = [], this.normals = [],
      this.texCoords = [], this.indices = [], this.interleavedVertices = [],
      this.stride = 32,
      t &&
    ...
    Smal.Cone.prototype = {
      set : function(t, i, e, s, r) {
        return this.baseRadius = t, this.height = i, this.sectorCount = e,
               this.stackCount = s, this.smooth = r,
               this.buildUnitCircleVertices(),
               this.smooth ? this.buildVerticesSmooth()
                           : this.buildVerticesFlat(),
               this
      ...
      setBaseRadius : function(t) {
        return this.baseRadius != t &&
                   this.set(t, this.height, this.sectorCount, this.stackCount,
                            this.smooth),
               this
      },
      setHeight : function(t) {
        return this.height != t &&
                   this.set(this.baseRadius, t, this.sectorCount,
                            this.stackCount, this.smooth),
               this
      },
      setSectorCount : function(t) {
        return this.sectorCount != t &&
                   this.set(this.baseRadius, this.height, t, this.stackCount,
                            this.smooth),
               this
      },
      setStackCount : function(t) {
        return this.stackCount != t &&
                   this.set(this.baseRadius, this.height, this.sectorCount, t,
                            this.smooth),
               this
      },
      setSmooth : function(t) {
      ...
      buildVerticesSmooth : function() {
        ...
        for (o = 0; o <= this.stackCount; ++o)
          for (e = -.5 * this.height + o / this.stackCount * this.height,
              ...
              n = 1 - o / this.stackCount, h = 0, a = 0;
               h <= this.sectorCount; ++h, a += 3)
            o < this.stackCount ? (t = this.unitCircleVertices[a],
                                   i = this.unitCircleVertices[a + 1],
                                   this.addVertex(m, t * s, i * s, e),
                                   this.addNormal(m, f[a], f[a + 1], f[a + 2]))
                                : (this.addVertex(m, 0, 0, e),
                                   this.addNormal(m, x[a], x[a + 1], x[a + 2])),
                r = h / this.sectorCount, this.addTexCoord(c, r, n), m += 3,
                c += 2;
        let g = m / 3;
        for (e = .5 * -this.height, this.addVertex(m, 0, 0, e),
            this.addNormal(m, 0, 0, -1), this.addTexCoord(c, .5, .5), m += 3,
        ...
        for (o = 0, a = g + 1; o < this.sectorCount; ++o, ++a)
          o < this.sectorCount - 1 ? this.addIndices(d, g, a + 1, a)
        ...
        for (this.resizeArraysFlat(), g = C = A = x = 0, t = 0;
          ...
          for (vi1 = t * (this.sectorCount + 1),
            ...
            for (a = S[vi1], u = S[vi2], c = S[vi1 + 1], d = S[vi2 + 1],
                ...
                this.addTexCoord(C + 4, c.s, c.t),
                this.addTexCoord(C + 6, d.s, d.t),
                f = Smal.Cone.computeFaceNormal(a.x, a.y, a.z, c.x, c.y, c.z,
                                                u.x, u.y, u.z),
                e = 0;
                 e < 4; ++e)
              this.addNormal(g + 3 * e, f[0], f[1], f[2]);
            g += 12, C += 8,
                t < this.stackCount - 1
                    ? (this.addIndices(A, x, x + 2, x + 1),
                       this.addIndices(A + 3, x + 1, x + 2, x + 3), A += 6,
                       x += 4)
      ...
      getSideNormals : function() {
        let t = 2 * Math.PI / this.sectorCount, i = 0,
            e = Math.atan2(this.baseRadius, this.height), s = Math.cos(e),
            r = Math.sin(e), n = new Float32Array(3 * (this.sectorCount + 1));
        for (let e = 0, o = 0; e <= this.sectorCount; ++e, o += 3)
          i = e * t, n[o] = Math.cos(i) * s, n[o + 1] = Math.sin(i) * s,
          n[o + 2] = r;
        return n
      ...
      getApexNormals : function() {
        let t = 2 * Math.PI / this.sectorCount, i = 0,
            ...
            r = Math.sin(e), n = new Float32Array(3 * (this.sectorCount + 1));
        for (let e = 0, o = 0; e <= this.sectorCount; ++e, o += 3)
          0 == this.apexNormalMode ? (i = e * t, n[o] = Math.cos(i) * s,
                                      n[o + 1] = Math.sin(i) * s, n[o + 2] = r)
    ...
    Smal.Torus =
        function(t, i = 1, e = .5, s = 36, r = 18, n = !0) {
      this.gl = t,
      t ||
          log("[WARNING] Smal.Torus.contructor requires GL context as a param."),
      this.majorRadius = 1, this.minorRadius = .5, this.sectorCount = 36,
      this.sideCount = 18, this.smooth = !0, this.vertices = [],
      this.normals = [], this.texCoords = [], this.indices = [],
      this.interleavedVertices = [], this.stride = 32,
      t &&
          (this.vboVertex = t.createBuffer(), this.vboIndex = t.createBuffer()),
      this.set(i, e, s, r, n)
    },
    Smal.Torus.prototype = {
      set : function(t, i, e, s, r) {
        return this.majorRadius = t, this.minorRadius = i, this.sectorCount = e,
               e < 3 && (this.sectorCount = 3), this.sideCount = s,
               s < 3 && (this.sideCount = 3), this.smooth = r,
               r ? this.buildVerticesSmooth() : this.buildVerticesFlat(), this
      },
      setMajorRadius : function(t) {
        return this.majorRadius != t &&
                   this.set(t, this.minorRadius, this.sectorCount,
                            this.sideCount, this.smooth),
               this
      },
      setMinorRadius : function(t) {
        return this.minorRadius != t &&
                   this.set(this.majorRadius, t, this.sectorCount,
                            this.sideCount, this.smooth),
               this
      },
      setSectorCount : function(t) {
        return this.sectorCount != t &&
                   this.set(this.majorRadius, this.minorRadius, t,
                            this.sideCount, this.smooth),
               this
      },
      setSideCount : function(t) {
        return this.sideCount != t &&
                   this.set(this.majorRadius, this.minorRadius,
                            this.sectorCount, t, this.smooth),
               this
      },
      setSmooth : function(t) {
      ...
      buildVerticesSmooth : function() {
        let t, i, e, s, r, n, o, h, a, l, u, m, c, d, f, x;
        this.resizeArraysSmooth();
        let g, C, A = 1 / this.minorRadius, S = 2 * Math.PI / this.sectorCount,
                  p = 2 * Math.PI / this.sideCount;
        for (d = f = x = 0, l = 0; l <= this.sideCount; ++l)
          for (C = Math.PI - l * p, s = this.minorRadius * Math.cos(C),
              e = this.minorRadius * Math.sin(C), u = 0;
               u <= this.sectorCount; ++u)
            g = u * S, r = (t = s * Math.cos(g)) * A,
            n = (i = s * Math.sin(g)) * A, o = e * A,
            this.addNormal(d, r, n, o), t += this.majorRadius * Math.cos(g),
            i += this.majorRadius * Math.sin(g), this.addVertex(d, t, i, e),
            h = u / this.sectorCount, a = l / this.sideCount,
            this.addTexCoord(f, h, a), d += 3, f += 2;
        for (l = 0; l < this.sideCount; ++l)
          for (c = (m = l * (this.sectorCount + 1)) + this.sectorCount + 1,
              u = 0;
               u < this.sectorCount; ++u, ++m, ++c)
            this.addIndices(x, m, c, m + 1), x += 3,
                this.addIndices(x, m + 1, c, c + 1), x += 3;
        this.buildInterleavedVertices(), this.buildVbos()
      },
      buildVerticesFlat : function() {
        ...
        for (this.resizeArraysFlat(), c = d = f = m = 0, t = 0;
          ...
          for (l = t * (this.sectorCount + 1),
            ...
            this.addVertex(c + 3, o.x, o.y, o.z),
            this.addVertex(c + 6, h.x, h.y, h.z),
            this.addVertex(c + 9, a.x, a.y, a.z), this.addTexCoord(d, n.s, n.t),
            this.addTexCoord(d + 2, o.s, o.t),
            this.addTexCoord(d + 4, h.s, h.t),
            this.addTexCoord(d + 6, a.s, a.t),
            s = Smal.Torus.computeFaceNormal(n.x, n.y, n.z, o.x, o.y, o.z, h.x,
                                             h.y, h.z),
            this.addNormal(c, s[0], s[1], s[2]),
            this.addNormal(c + 3, s[0], s[1], s[2]),
            this.addNormal(c + 6, s[0], s[1], s[2]),
    ...
    Smal.isWebGLSupported =
        function() { return !!window.WebGLRenderingContext },
    Smal.getContextGL = function(t, e) {
      let s = null,
          r = [ "webgl", "experimental-webgl", "moz-webgl", "webkit-3d" ];
      for (i = 0; i < r.length; ++i)
        try {
          if (s = t.getContext(r[i], e))
            break
        } catch (t) {
        }
      return s || (log("[ERROR] Failed to get WebGL rendering context."),
      ...
      return i ? function(e) { return t[i](e) }
               : function(t) { return setTimeout(t, 16) }
      ...
      let i = Smal.getAvailableFunctionFromList(t, [
        "animationStartTime", "mozAnimationStartTime", "msAnimationStartTime",
        "oAnimationStartTime", "webkitAnimationStartTime"
      ]);
      return i ? function() { return t[i] } : function() { return Date.now() }
      ...
      if (!e)
        return log("[WARNING] Cannot load GLSL shader source. The source ID is NULL."),
               null;
      let s, r = "", n = e.firstChild;
      for (; n;)
        3 == n.nodeType && (r += n.textContent), n = n.nextSibling;
      ...
      return t.shaderSource(s, r), t.compileShader(s),
      ...
      return Promise.all(s.map(Smal.loadFile)).then(i => {
        let e = t.createShader(t.VERTEX_SHADER),
            s = t.createShader(t.FRAGMENT_SHADER);
        if (t.shaderSource(e, i[0]), t.compileShader(e),
            !t.getShaderParameter(e, t.COMPILE_STATUS))
          return log("[ERROR] Vetex Shader: " + t.getShaderInfoLog(e)), null;
        if (t.shaderSource(s, i[1]), t.compileShader(s),
            !t.getShaderParameter(s, t.COMPILE_STATUS))
          return log("[ERROR] Fragment Shader: " + t.getShaderInfoLog(s)), null;
        let r = t.createProgram();
        return r.uniform = {}, r.attribute = {}, t.attachShader(r, e),
               t.attachShader(r, s), t.deleteShader(e), t.deleteShader(s),
               t.linkProgram(r),
               t.getProgramParameter(r, t.LINK_STATUS)
                   ? (Smal.addUniformLocations(t, r),
                      Smal.addAttributeLocations(t, r), r)
                   : (log("[ERROR] Failed to link GLSL: " +
                          t.getProgramInfoLog(r)),
                      null)
      })
    }, Smal.addUniformLocations = function(t, i) {
      let e, s = t.getProgramParameter(i, t.ACTIVE_UNIFORMS);
      for (e = 0; e < s; ++e) {
        let s, r, n, o = t.getActiveUniform(i, e), h = o.name.indexOf("."),
                     a = o.name.indexOf("[");
        if (h >= 0)
          s = o.name.substring(0, h), r = o.name.substring(h + 1),
          void 0 === i.uniform[s] && (i.uniform[s] = {}),
          i.uniform[s][r] = t.getUniformLocation(i, o.name);
        else if (a >= 0) {
          n = o.name.substring(0, a), i.uniform[n] = t.getUniformLocation(i, n),
          i.uniform[n][0] = t.getUniformLocation(i, o.name);
          let e = 1, s = !0;
          for (; s;)
            r = n + "[" + e + "]", i.uniform[n][e] = t.getUniformLocation(i, r),
            i.uniform[n][e] || (s = !1), ++e
        } else
          i.uniform[o.name] = t.getUniformLocation(i, o.name)
      }
      ...
      t.vboDummy = t.createBuffer(), t.bindBuffer(t.ARRAY_BUFFER, t.vboDummy),
      ...
      let n = new Image;
      return n.src = i, n.crossOrigin = "anonymous",
             n.onload = function() { Smal.setupTexture(t, r, n, e), s && s(r) },
             n.onerror = function() {
      ...
      return n.src = i, n.crossOrigin = "anonymous",
             n.onload = function() { Smal.setupTexture(t, r, n, e), s && s(r) },
             n.onerror = function() {
               s && s(null), log("[ERROR] Failed to load a normalmap " +
                                 i.substring(i.lastIndexOf("/") + 1))
             }, r
      ...
      let n = new Image;
      return n.src = i, n.crossOrigin = "anonymous", n.onload = function() {
        Smal.setupTexture(t, r, n, e, Smal.TextureType.OCCLUSIONMAP), s && s(r)
      }, n.onerror = function() {
        s && s(null), log("[ERROR] Failed to load an occlusionmap " +
                          i.substring(i.lastIndexOf("/") + 1))
      }, r
    }, Smal.loadCubemap = function(t, i, e) {
      let s = i.lastIndexOf("."), r = i.substring(0, s), n = i.substring(s),
          o = t.createTexture();
      Smal.setupDefaultTexture(t, o, Smal.TextureType.CUBEMAP);
      for (let i = 0; i < 6; ++i) {
        let s = r + i + n, h = new Image;
        h.src = s, h.crossOrigin = "anonymous",
        h.onload = function() { Smal.setupCubemap(t, o, h, i), e && e(o, i) },
        h.onerror = function() {
          e && e(null, i), log("[ERROR] Failed to load a cubemap " +
      ...
      r == Smal.TextureType.OCCLUSIONMAP && (n = t.LUMINANCE),
          ...
          t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER,
                          t.LINEAR_MIPMAP_LINEAR),
          1 == s ? (t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_S, t.REPEAT),
                    t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_T, t.REPEAT))
                 : (t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_S,
                                    t.CLAMP_TO_EDGE),
      ...
      t.bindTexture(t.TEXTURE_CUBE_MAP, i),
          t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X + s, 0, t.RGB, t.RGB,
                       t.UNSIGNED_BYTE, e),
          t.texParameteri(t.TEXTURE_CUBE_MAP, t.TEXTURE_MAG_FILTER, t.LINEAR),
          t.texParameteri(t.TEXTURE_CUBE_MAP, t.TEXTURE_MIN_FILTER,
                          t.LINEAR_MIPMAP_LINEAR),
          t.texParameteri(t.TEXTURE_CUBE_MAP, t.TEXTURE_WRAP_S,
                          t.CLAMP_TO_EDGE),
          t.texParameteri(t.TEXTURE_CUBE_MAP, t.TEXTURE_WRAP_T,
                          t.CLAMP_TO_EDGE),
          t.generateMipmap(t.TEXTURE_CUBE_MAP),
          t.bindTexture(t.TEXTURE_CUBE_MAP, null)
    }, Smal.setupDefaultTexture = function(t, i, e) {
      let s = t.RGBA, r = Smal.defaultTextureData;
      if (e == Smal.TextureType.NORMALMAP)
        r = Smal.defaultNormalmapData;
      else if (e == Smal.TextureType.OCCLUSIONMAP)
        r = Smal.defaultOcclusionmapData, s = t.LUMINANCE;
      else if (e == Smal.TextureType.CUBEMAP) {
        t.bindTexture(t.TEXTURE_CUBE_MAP, i);
        for (let i = 0; i < 6; ++i)
          t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X + i, 0, s, 1, 1, 0, s,
                       t.UNSIGNED_BYTE, r),
              t.texParameteri(t.TEXTURE_CUBE_MAP, t.TEXTURE_MAG_FILTER,
                              t.NEAREST),
              t.texParameteri(t.TEXTURE_CUBE_MAP, t.TEXTURE_MIN_FILTER,
                              t.NEAREST),
      ...
      return new Promise((i, e) => {
        let s = t.substring(t.lastIndexOf("/") + 1), r = new XMLHttpRequest;
        r.open("GET", t, !0), r.send(),
            r.onload = (() => {
              if (200 == r.status)
                i(r.response), log("Loaded file: " + s);
              else {
      ...
      let e = t;
      if (i == Smal.AnimationMode.EASE_IN)
        e = t * t * t;
      else if (i == Smal.AnimationMode.EASE_IN2)
        e = 1 - Math.sqrt(1 - t * t);
        ...
        let i = 1 - t, s = 4;
        e = t < .5 ? t * t * t * s : 1 - i * i * i * s
      } else
        i == Smal.AnimationMode.EASE_IN_OUT2
            ? e = t < .5 ? .5 * (1 - Math.sqrt(1 - t * t))
                         : .5 * Math.sqrt(1 - (1 - t) * (1 - t)) + .5
      ...
      h = h || function() {};
      let l = {};
      l.left = parseInt(a.style.left), l.top = parseInt(a.style.top),
      l.width = parseInt(a.style.width), l.height = parseInt(a.style.height),
      l.time = Date.now();
      let u = {};
      u.left = i, u.top = e, u.width = s, u.height = r, u.time = l.time + n,
      requestAnimationFrame(function t() {
        let i = Date.now();
        if (i >= u.time)
          return a.style.left = u.left + "px", a.style.top = u.top + "px",
                 a.style.width = u.width + "px",
                 a.style.height = u.height + "px", clearInterval(animId),
                 void h();
        let e = (i - l.time) / n;
      ...
      let e, s, r, n, o, h, a = {}, l = {}, u = {}, m = 0;
      for (let c = 0; c < i.length; c += 3)
        e = 3 * i[c], a.x = t[e], a.y = t[e + 1], a.z = t[e + 2],
        s = 3 * i[c + 1], l.x = t[s], l.y = t[s + 1], l.z = t[s + 2],
        r = 3 * i[c + 2], u.x = t[r], u.y = t[r + 1], u.z = t[r + 2],
        n = l.y * u.z - u.y * l.z, o = u.y * a.z - a.y * u.z,
        h = a.y * l.z - l.y * a.z, m += a.x * n + l.x * o + u.x * h;
      return 1 / 6 * m
    }, Smal.computeArea = function(t, i) {
      let e, s, r, n = {}, o = {}, h = {}, a = {}, l = {}, u = {}, m = 0;
      for (let c = 0; c < i.length; c += 3)
        e = 3 * i[c], n.x = t[e], n.y = t[e + 1], n.z = t[e + 2],
        s = 3 * i[c + 1], o.x = t[s], o.y = t[s + 1], o.z = t[s + 2],
        r = 3 * i[c + 2], h.x = t[r], h.y = t[r + 1], h.z = t[r + 2],
        a.x = o.x - n.x, a.y = o.y - n.y, a.z = o.z - n.z, l.x = h.x - n.x,
        l.y = h.y - n.y, l.z = h.z - n.z, u.x = a.y * l.z - l.y * a.z,
        u.y = a.z * l.x - l.z * a.x, u.z = a.x * l.y - l.x * a.y,
